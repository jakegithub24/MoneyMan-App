...
2. Monthly budget progress-bar rendering issue in 'today'
3. Back Navigation issue (app must close on 'back' from 'dashboard' screen)
4. Add invisible card in the end of 'Expense Categories' and 'Income Categories' list in 'Manage Categories' to avoid '+' (add category) button underlapping
5. Add icons to feature tabs of 'app lock configuration' in 'Security & Privacy' settings
    ...
    5.2 'password' icon for 'Change Security PIN'
